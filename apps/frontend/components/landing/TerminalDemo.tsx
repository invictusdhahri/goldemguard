...
const TABS = [
  {
    ...
    label: "install",
    lines: [
      { text: "# Install the GaulemGuard SDK", type: "comment" },
      { text: "", type: "blank" },
      { text: "npm install @gaulem/sdk", type: "normal" },
      { text: "", type: "blank" },
      { text: "# Or with pnpm", type: "comment" },
      { text: "pnpm add @gaulem/sdk", type: "normal" },
      { text: "", type: "blank" },
      { text: "✓ Installed @gaulem/sdk@2.4.1", type: "output" },
  ...
  },
  {
    ...
    label: "detect.ts",
    lines: [
      { text: "import { GaulemGuard } from '@gaulem/sdk';", type: "normal" },
      { text: "", type: "blank" },
      { text: "const guard = new GaulemGuard({", type: "normal" },
      { text: "  apiKey: process.env.GAULEM_KEY,", type: "normal" },
      { text: "});", type: "normal" },
      { text: "", type: "blank" },
  ...
  },
  {
    ...
    lines: [
      ...
      { text: '  "confidence": 0.973,', type: "normal" },
      { text: '  "model": "SigLIP-v1",', type: "string" },
      { text: '  "modality": "image",', type: "string" },
      { text: '  "latency_ms": 847,', type: "normal" },
      { text: '  "attribution": {', type: "normal" },
      { text: '    "regions": [...],', type: "normal" },
      { text: '    "artifacts": ["GAN_fingerprint", "semantic_inconsistency"]', type: "string" },
      { text: "  }", type: "normal" },
      { text: "}", type: "normal" },
    ] as CodeLine[],
  },
