          ...
          <article className="mt-6 md:mt-0">
            <DocsSection id="features" title="🚀 Features">
              <ul className="space-y-3 text-foreground/80">
                <li>
                  <strong className="text-foreground">Multi-Modal Detection:</strong> Images, videos, audio, and documents
                </li>
                <li>
                  <strong className="text-foreground">Automatic Fallbacks:</strong> If one model fails, backups kick in
                  automatically
                </li>
                <li>
                  <strong className="text-foreground">Plain-English Explanations:</strong> Powered by Claude Haiku 4.5
                </li>
                <li>
                  <strong className="text-foreground">100% Open Source:</strong> Built with cutting-edge AI models
                </li>
                <li>
                  <strong className="text-foreground">Zero-Budget:</strong> Runs entirely on free tiers
                </li>
              </ul>
            </DocsSection>
            ...
            <DocsSection id="tech-stack" title="🛠️ Tech Stack">
              <ul className="grid gap-3 sm:grid-cols-2">
                <li className="rounded-xl border border-border bg-secondary/50 px-4 py-3">
                  <strong className="text-foreground">Frontend:</strong> Next.js 14, Tailwind CSS, shadcn/ui
                </li>
                <li className="rounded-xl border border-border bg-secondary/50 px-4 py-3">
                  <strong className="text-foreground">Backend:</strong> Express.js, BullMQ, Redis
                </li>
                <li className="rounded-xl border border-border bg-secondary/50 px-4 py-3">
                  <strong className="text-foreground">ML Service:</strong> FastAPI, PyTorch, HuggingFace Transformers
                </li>
                <li className="rounded-xl border border-border bg-secondary/50 px-4 py-3">
                  <strong className="text-foreground">Database:</strong> Supabase (PostgreSQL + Storage)
                </li>
                <li className="rounded-xl border border-border bg-secondary/50 px-4 py-3">
                  <strong className="text-foreground">AI:</strong> Claude Haiku 4.5 (verdict generation)
                </li>
                <li className="rounded-xl border border-border bg-secondary/50 px-4 py-3">
                  <strong className="text-foreground">Deployment:</strong> Vercel (frontend), HuggingFace Spaces (ML),
                  Railway (backend)
                </li>
              </ul>
            </DocsSection>
            ...
            <DocsSection id="installation" title="📦 Installation">
              ...
              <h3 className="mt-10 text-lg font-semibold text-foreground">ML Service Setup</h3>
              <CodeBlock code={ML_SETUP} className="mt-4" />
            </DocsSection>

            <DocsSection id="testing" title="🧪 Testing">
              <h3 className="text-lg font-semibold text-foreground">Backend tests</h3>
            ...
            <DocsSection id="models" title="📊 Models Used">
              <h3 className="text-lg font-semibold text-foreground" id="models-image">
                Image Detection
              </h3>
              <ul className="mt-3 list-disc space-y-1 pl-5 text-foreground/80">
            ...
            <DocsSection id="license" title="📄 License">
              <p className="text-foreground/80">
                MIT License - see <code className="rounded bg-secondary px-1.5 py-0.5 font-mono text-sm">LICENSE</code>{' '}
                file
              </p>
            </DocsSection>
            ...
            <DocsSection id="team" title="👥 Team">
              ...
              <p className="mt-6 text-muted-foreground">Made with ❤️ for truth and transparency</p>
            </DocsSection>
          </article>
        </div>
      </div>
